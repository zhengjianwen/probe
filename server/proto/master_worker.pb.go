...
type HttpSpec struct {
	...
	StrBody   string             `protobuf:"bytes,6,opt,name=StrBody,json=strBody" json:"StrBody,omitempty"`
	BinBody   []byte             `protobuf:"bytes,7,opt,name=BinBody,json=binBody,proto3" json:"BinBody,omitempty" xorm:"json"`
...
func (m *HttpSpec) GetStrBody() string {
	if m != nil {
		return m.StrBody
	}
	return ""
...
func (m *HttpSpec) GetBinBody() []byte {
	if m != nil {
		return m.BinBody
	}
	return nil
...
var fileDescriptor0 = []byte{
	...
	,
}
